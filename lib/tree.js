...
Tree.prototype.cd = function(path, callback){
	...
	this.get_node(path, function(node){
...
Tree.prototype.rm = function(stack_name, callback){
	...
	this.get_node('/' + stack_name, function(node){
		if(node){
			callback(node);
		}else{
...
Tree.prototype.info = function(options, callback){
