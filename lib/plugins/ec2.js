...
EC2.prototype.do_cmd = function(args, callback){
	...
	switch(args[0]){
		...
		case 'pwd': pwd(args, callback); break;
...
function full_path(addon){
	return (path === '') ? '' : path + '/' + addon;
}
